      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {products.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">Aún no se han agregado productos al catálogo.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            {products.map((product) => (
              <div key={product.id} className="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden group">
                {/* Image */}
                ...
                <div className="p-4">
                  <div className="flex items-start justify-between mb-2">
                    <h3 className="text-sm font-medium text-gray-900 truncate pr-2">{product.titulo}</h3>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-lg font-semibold text-gray-900">${product.precio.toFixed(2)}</span>
                    <span className="text-xs text-gray-500">{product.existencias} disponibles</span>
                  </div>
                  ...
                  <div className="flex space-x-2">
                    ...
                    <button
                      ...
                      className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-900 text-xs font-medium py-2 px-3 rounded-lg transition-colors"
                    >
                      Ver
                    </button>
                  </div>
